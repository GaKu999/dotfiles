...
if has("gui_running")
	if (&background == "dark")
		...
		highlight StatusLine   guifg=#f5f5f5 guibg=NONE gui=bold
		highlight StatusLineNC guifg=#505050 guibg=NONE gui=NONE
...
elseif ((match($PARENT_TERM, 'foot*') != -1) || (match($TERM, 'foot*') != -1))
	...
	if (&background == "dark")
		...
		highlight StatusLineNC ctermfg=0 ctermbg=NONE cterm=bold
